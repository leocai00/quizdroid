...
class TopicFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        when(param1) {
            "Math" -> description.text = getString(R.string.math)
            "Physics" -> description.text = getString(R.string.physics)
            else -> description.text = getString(R.string.heroes)
        }
        val  quizPage : QuizFragment = QuizFragment.newInstance(param1, IntArray(2, {0}))
